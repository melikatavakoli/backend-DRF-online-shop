...
class ConsultantAdmin(BaseAdmin):
    ...
    list_display = (
        "user", "is_present", "education", "major","_deleted_at", "_is_deleted",
    )
...
class StudentAdmin(BaseAdmin):
    ...
    list_display = (
        "user","grade","field","_deleted_at", "_is_deleted"
    )
...
class TopStudentAdmin(BaseAdmin):
    ...
    list_display = (
        "full_name","field","rank","branch","_created_at", "_updated_at","_deleted_at", "_is_deleted"
    )
...
class SpecialityAdmin(BaseAdmin):
    list_display = ("title", "_created_at", "_updated_at", "_deleted_at", "_is_deleted")
